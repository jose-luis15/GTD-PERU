...
########################################################################
# Código para cambiar de .ui a .py en consola
# pyuic5 -x Principal_Window2.ui -o interfaz.py

# Importamos las librerias que necesitaremos (istaladas previamente)
from PyQt5 import QtWidgets, uic
import os, shutil, simplekml

# os.chdir(r'c:/Users/Jose Luis/Desktop/FOLDER_FACTIBILIDADES')

# Iniciar la aplicación
app = QtWidgets.QApplication([])

# Cargar archivos .ui
principal = uic.loadUi("Principal_Window2.ui")
